function factorList = constructDecoupledGeneticNetwork2(pedigree, alleleFreqs, alphaList)
...
for i=1:numPeople
    if(sum(pedigree.parents(i,:)) ~= 0)
        ...
        factorList(i+numPeople) = childCopyGivenParentalsFactor(numAlleles, i+numPeople, pedigree.parents(i,2), numPeople+pedigree.parents(i,2));
