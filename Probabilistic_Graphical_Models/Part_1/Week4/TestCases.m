...
load 'FullI.mat';
out = SimpleCalcExpectedUtility(FullI); 

FullI.RandomFactors = ObserveEvidence(FullI.RandomFactors, [3, 2], true);
out2 = SimpleCalcExpectedUtility(FullI); 

load 'TestI0.mat';
[initialMeu optdr] = OptimizeWithJointUtility(TestI0);

#T1
TestI0.RandomFactors(10).val(1) = 0.75;
TestI0.RandomFactors(10).val(2) = 0.25;
TestI0.RandomFactors(10).val(3) = 0.001;
TestI0.RandomFactors(10).val(4) = 0.999;
TestI0.DecisionFactors(1).var = [9,11];
TestI0.DecisionFactors(1).card = [2,2];
TestI0.DecisionFactors(1).val = [0,1,0,0];

[meuT1 optdr] = OptimizeWithJointUtility(TestI0);

vpiT1 = meuT1 - initialMeu;
costT1 = exp(vpiT1/100) - 1;

#T2
TestI0.RandomFactors(10).val(1) = 0.999;
TestI0.RandomFactors(10).val(2) = 0.001;
TestI0.RandomFactors(10).val(3) = 0.25;
TestI0.RandomFactors(10).val(4) = 0.75;
TestI0.DecisionFactors(1).var = [9,11];
TestI0.DecisionFactors(1).card = [2,2];
TestI0.DecisionFactors(1).val = [1,0,0,0];

[meuT2 optdr] = OptimizeWithJointUtility(TestI0);
vpiT2 = meuT2 - initialMeu;
costT2 = exp(vpiT2/100) - 1;
...
[meuT3 optdr] = OptimizeWithJointUtility(TestI0);
vpiT3 = meuT3 - initialMeu;
costT3 = exp(vpiT3/100) - 1;
