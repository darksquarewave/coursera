...
alphaList = [0.8; 0.6; 0.1];
%sampleFactorList2 = load('sampleFactorList.mat'); % Comment out this line for testing
...
sampleFactorListDecoupled = constructDecoupledGeneticNetwork2(pedigree, alleleFreqsThree, alphaListThree);
...
lg = logit(phenotypeFactorSigmoid.val);
